...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="cc8scphbwfp9kt3t",
        public_key="yd9qdjx39xwrfpbz",
        private_key="4274bc59e8f589f635a6245c17da3235"
    )
)
...
def generate_token(request, id, token):
    if not validate_user_session(id, token):
        return JsonResponse({'error': 'Sessão inválida, faça o login novamente!'})
